...
return Scaffold(
  ...
  body: Container(
    ...
    child: Center(
      ...
      child: MouseRegion(
        ...
        child: SingleChildScrollView(
          ...
          child: Container(
            height: MediaQuery.of(context).size.height < 500 ? 520
             :MediaQuery.of(context).size.height < 700 ? 550 : 600,
                            ...
                            decoration: BoxDecoration(
                             ...
                             child: Padding(
                               ...
                               textSelectionTheme: TextSelectionThemeData(
                                   ...
                                   contentPadding: EdgeInsets.symmetric(vertical:noUsername ? MediaQuery.of(context).size.height < 700 ? 10 :
    ...
    .from('detail')
    .select()
    .gte('starttime', billingStart.toIso8601String())
    .lt('starttime', nextBilling.toIso8601String());
                                          
                                     
                                              if (response3['subscription'] != null) {
                                                
                                                if (response3['subscription'] == 'Basic') {
                                                  if (responsee.length >= 500) {
                                                    sendwarning = true;
                                                  }
                                                } else if (response3['subscription'] == 'Pro') {
                                                  if (responsee.length >= 1000) {
                                                    sendwarning = true;
                                                  }
                                                }
                                              }
                       ...
                       errorText = "Please don't leave a field blank";
                           ...
                           fontWeight: FontWeight.bold
                               ...
                               contentPadding: EdgeInsets.symmetric(vertical:noPassword ? MediaQuery.of(context).size.height < 700 ? 10 :
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            isLoading ? SizedBox(
                              width: 20,
                              height: 20,
                              child: CircularProgressIndicator(color: Colors.blue, strokeWidth: 2,)) : SizedBox.shrink()
                          ],
                        ),
